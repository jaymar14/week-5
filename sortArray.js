...
function bubbleSort(numberArray){
  ...
  for(var i = 0 ; i < numberArray.length ; i++){
    ...
    if(num1 > num2){
      ...
      didWeSwapAnything = true;
    }
  }

  return {didWeSwapAnything: didWeSwapAnything, numberArray: numberArray};
}

var isDone = false;
do {
  var workArray = numbers;
  var result = bubbleSort(workArray);

  numbers = result.numberArray;
  isDone = !result.didWeSwapAnything;
}
while (!isDone);
